...
Path= paths_allowed("https://en.wikipedia.org/wiki/The_World%27s_Billionaires")
...
billinores_table <- html_table(my_tables)[[1]]

# VIEW THE TABLE
View(billinores_table)

# TAKE ONLY THE SECOND AND THIRD COLUMN FROM THE TABLE AND STORE IT IN A VARIABLE

billinores <- billinores_table[,2:3]
